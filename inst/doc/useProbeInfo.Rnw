...
match2 = matchPattern(as.character(myPr[1,1]), mybs)

nchar(match2)

## "revString" removed by WH 6.6.06
## match2 = matchPattern(revString(as.character(myPr[1,1])), mybs)
match2 = matchPattern(reverseComplement(DNAString(myPr[1,1])), mybs)
