...
human, mouse, or rat. \Rpackage{KEGG.db} and \Rpackage{GO.db} are source
...
The \Rpackage{KEGG.db} library contains mappings between ids such as Locuslink
and \Rpackage{GO} to \Rpackage{KEGG} pathway ids and thus pathway names.
The \Rpackage{GO.db} library maintain the directed acyclic graph structure of the original
...
After downloading libraries \Rpackage{hgu95av2.db} and
\Rpackage{GO.db} from the link to MetaData of the Bioconductor web site,
...
a library basename proceeded by a question mark (e. g. ?hgu95av2) and
the library basename followed by a pair of brackets (e. g. hgu95av2()),
...
The name of an environment object consists of package basename (\Rpackage{hgu95av2.db}) and
